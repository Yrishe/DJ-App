...
void DeckView::resized()
{
    ...
    // Center - Waveform and jog wheel
    auto centerArea = mainArea.removeFromLeft(mainArea.getWidth() - 80);
    
    // Waveform
    auto waveformArea = centerArea.removeFromTop(120);
    waveformDisplay->setBounds(waveformArea.reduced(5));
    
    centerArea.removeFromTop(10); // Spacing
    
    // Jog wheel
    auto jogArea = centerArea.removeFromTop(200);
